...
<section class="page-hero">
    ...
    <div class="page-hero-angled-img-wrap">
        <img src="assets/images/evia-morning.png" alt="Healthy breakfast bowl with Evia" class="page-hero-angled-img">
    </div>
    ...
    <div class="container page-hero-grid">
        <div class="page-hero-content">
            <div class="badge-tag">WHY IT WORKS</div>
        ...
        <div class="page-hero-right">
            <img src="assets/images/evia_breakfast_bowl.png" alt="Healthy breakfast bowl with Evia"
...
<!-- Why fibre matters split -->
<section class="section section-light">
    <div class="container">
        <div class="media-split">
            <div class="media-split-text">
                <div class="badge-tag">THE SHORTFALL</div>
            ...
            <div class="media-split-media">
                <img src="assets/images/evia-girl-kitchen.png" alt="Healthy morning with Evia">
            </div>
        </div>
    </div>
</section>
...
<!-- How it works -->
<section class="why-different" id="how-it-works-why" style="border-top: none;">
    <div class="container why-inner-container">
        <div class="why-left-side">
            <div class="badge-tag" style="color: var(--purple); margin-bottom: 24px;">THE ROUTINE</div>
            <h2>How the routine works</h2>
            ...
            <div class="why-grid-cols">
                ...
                <div class="why-col">
                    ...
                    <div class="why-content">
                        <h4>Tear</h4>
                        <p>Snap open a single one-ounce serving. No scooping, no measuring.</p>
                    </div>
                </div>
                ...
                <div class="why-col">
                    ...
                    <div class="why-content">
                        <h4>Drink</h4>
                        <p>Take it straight or stir into water. Smooth, light, no grit.</p>
                    </div>
                </div>
                ...
                <div class="why-col">
                    ...
                    <div class="why-content">
                        <h4>Done</h4>
                        <p>Get on with your day, fibre handled before the first email.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- The lifestyle lemon kitchen image instead of the blue block -->
    <img src="assets/images/evia-lemon-kitchen.jpg" class="routine-bg-image" alt="How the routine works">
