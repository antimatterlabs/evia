<?php
$pageTitle       = 'Contact | Evia';
$pageDescription = 'Questions about your order, the routine, or anything else? Get in touch with the Evia team.';
$activeNav       = '';
...
<section class="page-hero">
    ...
    <div class="page-hero-angled-img-wrap">
        <img src="assets/images/evia_blog_coffee.png" alt="Contact Evia support" class="page-hero-angled-img">
    </div>
    ...
    <div class="container page-hero-grid">
        <div class="page-hero-content">
            <div class="badge-tag">SAY HELLO</div>
            <div class="page-hero-title-wrap">
                <h1>Get in touch</h1>
                <img src="assets/images/evia_smiley_face.png" alt="Happy Face" class="page-hero-smiley">
            </div>
            <p>Questions about your order, the ingredients, or whether Evia's right for you? We read every message.</p>
        </div>
        <div class="page-hero-right">
            <img src="assets/images/evia_blog_coffee.png" alt="Contact Evia support" class="page-hero-mobile-img">
        </div>
    </div>
</section>
                ...
                <form action="#" method="post" novalidate>
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input class="field" type="text" id="firstName" name="firstName" placeholder="Jordan">
                        </div>
                        <div class="form-group">
                            <label for="lastName">Last name</label>
                            <input class="field" type="text" id="lastName" name="lastName" placeholder="Rivera">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="field" id="topic" name="topic">
                            <option>An existing order</option>
                            <option>Subscriptions &amp; billing</option>
                            <option>Product &amp; ingredients</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="field" id="message" name="message" placeholder="Tell us how we can help…"></textarea>
                    </div>

                    <button type="submit" class="btn btn-purple btn-lg">Send message</button>
                </form>
            </div>

            <!-- Info -->
            <div class="contact-info">
                <div class="contact-info-card card-purple">
                    <div class="ci-icon icon-purple">
                    ...
                    <h4>Email us</h4>
                    <p><a href="mailto:hello@evia.com">hello@evia.com</a><br>We reply within one business day.</p>
                </div>

                <div class="contact-info-card card-blue">
                    <div class="ci-icon icon-blue">
                    ...
                    <h4>Support hours</h4>
                    <p>Monday–Friday, 9am–5pm ET.<br>Messages outside hours are answered next business day.</p>
                </div>

                <div class="contact-info-card card-pink">
                    <div class="ci-icon icon-pink">
                    ...
                    <h4>Find us</h4>
                    <p>Prefer the quick stuff? Most answers live on our <a href="faq.php">FAQ page</a>.</p>
                    <div class="footer-socials" style="margin-top:14px;">
                        <a href="#" class="social-link" aria-label="Instagram" style="color:var(--purple);"><i class="fa-brands fa-instagram"></i></a>
                        <a href="#" class="social-link" aria-label="Twitter" style="color:var(--purple);"><i class="fa-brands fa-x-twitter"></i></a>
                        <a href="#" class="social-link" aria-label="TikTok" style="color:var(--purple);"><i class="fa-brands fa-tiktok"></i></a>
                    </div>
                </div>
            </div>
